...
customElements.define('action-handler-plant-humidity', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-plant-humidity')) {
    return body.querySelector('action-handler-plant-humidity') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-plant-humidity');
