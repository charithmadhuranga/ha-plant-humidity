...
import { PlantHumidityCardConfig } from './types';
...
@customElement('plant-humidity-card-editor')
export class PlantHumidityCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @state() private _config?: PlantHumidityCardConfig;
